...
| Signed build, exact namespace and isolated local runtime                           | Original #55 preparation retained as history; [#57](acceptance-57.md#exact-candidate-and-environment) records the performed source, signed install and stable isolated namespace/runtime. Later review-repair source and automated evidence are recorded in [the epic ledger](acceptance-48.md).                                                                                   |
